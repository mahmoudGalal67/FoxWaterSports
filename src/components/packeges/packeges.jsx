    ...
    <section id='Packeges' className='packeges'>
      ...
      <div className="packeges_cards-wrapper">
        <div className="packege-card" data-aos="fade-right">
          <img src={require('../assets/images/packages/1.webp')} loading='lazy' alt="car jetski in dubai" />
        ...
        <div className="packege-card" data-aos="fade-up">
          <img src={require('../assets/images/packages/2.webp')} loading="lazy" alt="flying fox water sports" />
        ...
        <div className="packege-card" data-aos="fade-up">
          <img src={require('../assets/images/packages/3.webp')} loading="lazy" alt="performance jetski in dubai" />
        ...
        <div className="packege-card" data-aos="fade-left">
          <img src={require('../assets/images/packages/4.webp')} loading="lazy" alt="where to do jetski in dubai" />
        ...
        <div className="packege-card" data-aos="fade-right">
          <img src={require('../assets/images/packages/5.webp')} loading="lazy" alt="best jet ski dubai" />
        ...
        <div className="packege-card" data-aos="fade-up">
          <img src={require('../assets/images/packages/6.webp')} loading="lazy" alt="jetski for sale in dubai" />
        ...
        <div className="packege-card" data-aos="fade-up">
          <img src={require('../assets/images/packages/7.webp')} loading="lazy" alt="jetski rental in dubai" />
        ...
        <div className="packege-card" data-aos="fade-left">
          <img src={require('../assets/images/packages/8.webp')} loading="lazy" alt="jet ski crash dubai" />
      ...
      <div className="packeges-details">
        <div className="left" data-aos="fade-right">
          <img src={require("../assets/images/packages/main.webp")} loading="lazy"  alt="cheap jet ski dubai" />
        </div>
      ...
      <div className="owl-carousel packeges-carousel">
        <div className='packeges-carousel-item'><img loading='lazy' src={require("../assets/images/Gallay/WhatsApp-Image-2021-11-22-at-23.59 (2).webp")} alt="flying fox water sports" /></div>
        <div className='packeges-carousel-item'><img loading='lazy' src={require("../assets/images/Gallay/flyboard-img-1.webp")} alt="car jetski in dubai" /></div>
        <div className='packeges-carousel-item'><img loading='lazy' src={require("../assets/images/Gallay/donut-ride_2.webp")} alt="car jetski in dubai" /></div>
        <div className='packeges-carousel-item'><img loading='lazy' src={require("../assets/images/Gallay/Cruising-Thumb 4.webp")} alt="flying fox water sports" /></div>
        <div className='packeges-carousel-item'><img loading='lazy' src={require("../assets/images/Gallay/WhatsApp-Image-2021-11-22-at-23.59 (1).webp")} alt="car jetski in dubai" /></div>
      </div>
